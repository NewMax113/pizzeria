...
let test = (e: React.ChangeEvent<HTMLInputElement>) => {e.target.checked === false ? setStatus({category: e.target.value, boolean: e.target.checked}) : setStatus({category: null, boolean: null}); setCheced([...checked, {category: e.target.value, boolean: e.target.checked}])}
